...
<acme:form readonly="true">
	...
	<acme:button code="any.sponsorship.form.button.donations" action="/any/donation/list?id=${id}"/>
	<acme:button code="any.sponsorship.form.button.sponsor" action="/any/sponsor/show?id=${id}"/>
</acme:form>
